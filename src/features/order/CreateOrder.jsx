  ...
  return (
    <div className="px-4 py-6">
      ...
      <Form method="POST">
        ...
        <div>
            <div className="relative mb-5 flex gap-2 flex-color sm:flex-row sm:items-center">
              ...
              <div className="grow">
                ...
                />
                {addressStatus === 'error' && <p className="text-xs mt-2 bg-red-100 text-red-700 rounded-md">{errorAddress}</p>}
            </div>
